    ...
    <main>
        <div class="sideBar">
            <div class="sideBar__section">
                ...
                <div class="sideBar__item">
                    <a href=""><fmt:message key="black_list"/></a>
                </div>
            </div>
            <div class="sideBar__section">
                <div class="sideBar__item">
        ...
        <div class="table">
            <table class="table-bordered">
                <form action="hotel" method="post">
                    <tr>
                        <th><fmt:message key="ban_id"/></th>
                        <th><fmt:message key="client_id"/></th>
                        <th><fmt:message key="ban_reason"/></th>
                        <th></th>
                    </tr>
                    <c:if test="${requestScope.blackList != null}">
                        <c:forEach var="ban" items="${requestScope.blackList}">
                            <tr>
                                <td>${ban.id}</td>
                                <td>${ban.client}</td>
                                <td>${ban.reason}</td>
                    ...
                    <tr>
                        <td></td>
                        <td>
                            <input type="text" name="ban_id" title="input client id">
                        </td>
                        <td>
                            <input type="text" name="ban_reason" title="input reason for ban">
                        </td>
                        <td>
                            <button>Add</button>
                            <input type="hidden" name="form" value="new_ban">
                        </td>
                    </tr>
                </form>
            </table>
